...
namespace IBoxs.Sdk.Cqp.Core
{
    internal static class CQP
    {
        ...
        public static extern IntPtr CQ_sendPrivateMsg (int authCode, long qqId, [In]IntPtr msg);

        [DllImport (DllName, EntryPoint = "CQ_sendGroupMsg")]
        public static extern IntPtr CQ_sendGroupMsg (int authCode, long groupId, [In]IntPtr msg);

        [DllImport (DllName, EntryPoint = "CQ_sendDiscussMsg")]
        public static extern IntPtr CQ_sendDiscussMsg (int authCode, long discussId, [In]IntPtr msg);

        [DllImport (DllName, EntryPoint = "CQ_deleteMsg")]
        public static extern IntPtr CQ_deleteMsg (int authCode, long msgId);

        [DllImport (DllName, EntryPoint = "CQ_sendLikeV2")]
        public static extern IntPtr CQ_sendLikeV2 (int authCode, long qqId, int times);

        [Obsolete ("请使用 CQ_getCookiesV2 版本 API")]
        [DllImport (DllName, EntryPoint = "CQ_getCookies")]
        public static extern IntPtr CQ_getCookies (int authCode);

        [DllImport (DllName, EntryPoint = "CQ_getCookiesV2")]
        public static extern IntPtr CQ_getCookiesV2 (int authCode, string domain);

        [Obsolete ("请使用 CQ_getRecordV2 版本 API")]
        [DllImport (DllName, EntryPoint = "CQ_getRecord")]
        public static extern IntPtr CQ_getRecord (int authCode, string file, string format);

        [DllImport (DllName, EntryPoint = "CQ_getRecordV2")]
        public static extern IntPtr CQ_getRecordV2 (int authCode, string file, string format);

        [DllImport (DllName, EntryPoint = "CQ_getCsrfToken")]
        public static extern IntPtr CQ_getCsrfToken (int authCode);
        ...
        public static extern IntPtr CQ_setGroupKick (int authCode, long groupId, long qqId, bool refuses);

        [DllImport (DllName, EntryPoint = "CQ_setGroupBan")]
        public static extern IntPtr CQ_setGroupBan (int authCode, long groupId, long qqId, long time);

        [DllImport (DllName, EntryPoint = "CQ_setGroupAdmin")]
        public static extern IntPtr CQ_setGroupAdmin (int authCode, long groupId, long qqId, bool isSet);

        [DllImport (DllName, EntryPoint = "CQ_setGroupSpecialTitle")]
        public static extern IntPtr CQ_setGroupSpecialTitle (int authCode, long groupId, long qqId, IntPtr title, long durationTime);

        [DllImport (DllName, EntryPoint = "CQ_setGroupWholeBan")]
        public static extern IntPtr CQ_setGroupWholeBan (int authCode, long groupId, bool isOpen);

        [DllImport (DllName, EntryPoint = "CQ_setGroupAnonymousBan")]
        public static extern IntPtr CQ_setGroupAnonymousBan (int authCode, long groupId, IntPtr anonymous, long banTime);

        [DllImport (DllName, EntryPoint = "CQ_setGroupAnonymous")]
        public static extern IntPtr CQ_setGroupAnonymous (int authCode, long groupId, bool isOpen);

        [DllImport (DllName, EntryPoint = "CQ_setGroupCard")]
        public static extern IntPtr CQ_setGroupCard (int authCode, long groupId, long qqId, IntPtr newCard);

        [DllImport (DllName, EntryPoint = "CQ_setGroupLeave")]
        public static extern IntPtr CQ_setGroupLeave (int authCode, long groupId, bool isDisband);

        [DllImport (DllName, EntryPoint = "CQ_setDiscussLeave")]
        public static extern IntPtr CQ_setDiscussLeave (int authCode, long disscussId);

        [DllImport (DllName, EntryPoint = "CQ_setFriendAddRequest")]
        public static extern IntPtr CQ_setFriendAddRequest (int authCode, string identifying, int requestType, IntPtr appendMsg);

        [DllImport (DllName, EntryPoint = "CQ_setGroupAddRequestV2")]
        public static extern IntPtr CQ_setGroupAddRequestV2 (int authCode, string identifying, int requestType, int responseType, IntPtr appendMsg);

        [DllImport (DllName, EntryPoint = "CQ_addLog")]
        public static extern IntPtr CQ_addLog (int authCode, int priority, string type, IntPtr Msg);

        [DllImport (DllName, EntryPoint = "CQ_setFatal")]
        public static extern IntPtr CQ_setFatal (int authCode, string errorMsg);
        ...
        public static extern IntPtr CQ_canSendRecord (int authCode);

        [DllImport (DllName, EntryPoint = "CQ_getImage")]
        public static extern IntPtr CQ_getImage (int authCode, string file);
